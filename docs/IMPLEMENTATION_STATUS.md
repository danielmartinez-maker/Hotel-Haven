...
- Integer smallest-currency authority for rates, wages, utilities and all ledger totals. Save format v7 round-trips exact deterministic state, validates the complete entity-reference graph and migrates v2-v6 saves.
