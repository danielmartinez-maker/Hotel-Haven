...
- Hybrid asset-backed world scene with cooked meshes for stairs, doors, beds, room furniture, bathroom fixtures, reception, service storage, plants and people; 70 startup bindings cover room, lobby, entrance, staff-area and character presentation, including all 30 guest variants plus receptionist, housekeeper and maintenance variants, with procedural fallbacks, floor selection, cutaway and diagnostic colors.
