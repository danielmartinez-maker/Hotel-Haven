...
def generate_all(repo_root:Path|str):
 ...
 mech_clips,mech_sets=generate_mechanical(exports/'Animations');hum_skeletons,hum_clips,hum_sets=generate_humanoid(root/'GameData/AssetDefinitions/animation_sets_v1.json',exports/'AnimationsHumanoid');linked,deferred=link(manifest_dir,exports)
 summary={'schema':1,'batch_counts':batch_counts,'gameplay_asset_count':sum(batch_counts.values()),'mechanical_clips':mech_clips,'mechanical_sets':mech_sets,'humanoid_skeletons':hum_skeletons,'humanoid_clips':hum_clips,'humanoid_sets':hum_sets,'animation_links':linked,'animation_links_deferred':deferred}
