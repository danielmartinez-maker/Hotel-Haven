...
def generate_package(manifest_path: Path|str, output_dir: Path|str, source_path='Tools/ArtGeneration/batch06_generate.py'):
    ...
    for group in data['groups']:
        ...
        for row in group['assets']:
            ...
            sidecar={'schema':1,'asset_id':asset_id,'asset_type':'StaticMeshAsset','source':source_path,'units':'meters','lod_policy':'lod_furniture','collision_policy':'simple_proxy','cutaway_policy':'normal','material_slots':[mat],'tags':tags,'dependencies':[],'milestone':'batch_06','source_revision':1,'metadata_revision':1}
