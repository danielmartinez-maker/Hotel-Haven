...
std::size_t OperationsDashboard::filteredCount(OperationArea area) const noexcept { return filteredCount(OperationsFilter{area}); }
...
std::vector<OperationRow> OperationsDashboard::filteredWindow(OperationArea area, std::size_t offset, std::size_t count) const { return filteredWindow(OperationsFilter{area}, offset, count); }
